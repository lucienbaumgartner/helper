...
load('~/r-helpers/reverse-geocoding/input/0x-geonames-cities1000.RData')
load('~/r-helpers/reverse-geocoding/input/0x-geonames-cities1000-coord-source-reverse-geocoding.RData')

reverse_geocode_city <- function(data, query, geo.source.coordinates = geonames.coord, geo.source.full = geonames.df, n.nearest.neighbours, n.cores = NULL){
