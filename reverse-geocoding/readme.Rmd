...
q <- ggplot(geo) +
  ...
  labs(title='Distance differences of reverse geocoded cities to actual geo coordinates from Twitter', 
       subtitle='Only non-identical results are shown.')
q
